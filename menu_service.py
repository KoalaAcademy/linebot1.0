        ...
        for skill in requirement:
            if skill in course_links:
                ...
                if level == 'Beginner':
                    links.extend(
                        [
                            f'{skill} 初級課程連結：\n\n{course_links[skill][level]}',
                            f'{skill} 中級課程連結：\n\n{course_links[skill]['Intermediate']}'
                        ]
                    )
                elif level == 'Intermediate':
                    links.append(f'{skill} 高級課程連結：\n\n{course_links[skill]['Advanced']}')
                else:
                    links.append(f'{skill} 大師級課程連結：\n\n{course_links[skill]['Expert']}')
